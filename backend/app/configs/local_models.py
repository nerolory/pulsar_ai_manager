...
LOCAL_MODELS: dict[str, dict[str, ModelInfo]] = {
    "very_light": {
        "tinyllama-1.1b": ModelInfo(
            ...
            params="1.1B",
            tier="very_light",
            requirements=ModelRequirements(ram_gb=3.0, cpu_cores=2, disk_gb=3.0, gpu_vram_gb=None),
        ...
        "phi-3-mini-2.7b": ModelInfo(
            ...
            params="2.7B",
            tier="very_light",
            requirements=ModelRequirements(ram_gb=4.0, cpu_cores=2, disk_gb=4.0, gpu_vram_gb=None),
    ...
    "light": {
        "phi-3-mini-3.8b": ModelInfo(
            ...
            params="3.8B",
            tier="light",
            requirements=ModelRequirements(ram_gb=6.0, cpu_cores=4, disk_gb=6.0, gpu_vram_gb=4.0),
            download_url="https://huggingface.co/microsoft/Phi-3-mini-4k-instruct",
            format="gguf",
            context_length=4096,
            quantization="4bit",
        ...
        "qwen-1.5-1.8b": ModelInfo(
            ...
            params="1.8B",
            tier="light",
            requirements=ModelRequirements(ram_gb=4.0, cpu_cores=4, disk_gb=4.0, gpu_vram_gb=None),
    ...
    "medium": {
        "phi-3-medium-4b": ModelInfo(
            ...
            params="4B",
            tier="medium",
            requirements=ModelRequirements(ram_gb=8.0, cpu_cores=6, disk_gb=8.0, gpu_vram_gb=6.0),
        ...
        "qwen-1.5-7b": ModelInfo(
            ...
            params="7B",
            tier="medium",
            requirements=ModelRequirements(ram_gb=12.0, cpu_cores=6, disk_gb=12.0, gpu_vram_gb=8.0),
